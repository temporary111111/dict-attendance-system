...
def main() -> None:
    ...
    write_drawio(
        ...
        [
            ...
            ("system", "program_admin", "Attendance sheet for actively assigned program events"),
    ...
    write_drawio(
        ...
        [
            ...
            ("attendee", "External Attendee", 430, 1390, 160, 40, EXTERNAL),
            ...
            ("p3", "3.0 Manage Events and Field Requirements", 1660, 700, 210, 210, PROCESS),
            ("p4", "4.0 Generate Attendance Link and QR Code", 390, 685, 285, 285, PROCESS),
            ("p5", "5.0 Collect Attendance Submission", 1025, 1400, 220, 220, PROCESS),
            ("p6", "6.0 Validate, Store, and Review Attendance Records", 1645, 1290, 285, 285, PROCESS),
            ...
            ("d4", "D4 Event Configuration", 2075, 1300, 215, 65, STORE),
            ("d5", "D5 Attendance Records", 2070, 1430, 220, 75, STORE),
            ("d6", "D6 Attendance Sheet Exports", 2060, 1570, 235, 75, STORE),
        ...
        [
            ...
            ("p2", "d2", ""),
            ("p2", "d3", ""),
            ("super_admin", "p3", "Event details, status, field requirements"),
            ("program_admin", "p3", "Assigned event and field requirement changes"),
            ("p3", "d2", ""),
            ("p3", "d3", ""),
            ("p3", "d4", ""),
            ...
            ("super_admin", "p6", "Attendance list, detail, and status review"),
            ("program_admin", "p6", "Review attendance under assigned program"),
            ("p6", "super_admin", "Attendance records and status result"),
            ("p6", "program_admin", "Assigned-program records and status result"),
            ...
            ("p7", "program_admin", "Reports and sheets for actively assigned program"),
    ...
    write_drawio(
        ...
        "DFD Level 2 - Attendance Submission, Review, and Sheet Generation",
        2750,
        1200,
        [
            ...
            ("p62", "6.2 Validate Event Field Requirements", 1200, 740, 220, 220, PROCESS),
            ...
            ("p67", "6.7 Review Attendance Record Status", 1450, 430, 240, 240, PROCESS),
            ("d2", "D2 Roles and Program Assignments", 770, 450, 240, 80, STORE),
            ("d4", "D4 Event Configuration", 1270, 640, 170, 60, STORE),
        ...
        [
            ...
            ("p51", "d4", "Event status and field requirements"),
            ...
            ("admin", "p67", "Search, view, or submit status with reason"),
            ("p67", "d2", ""),
            ("p67", "d4", ""),
            ("p67", "d5", ""),
            ("p67", "d7", ""),
            ("p67", "admin", "Paginated records, detail, or status result"),
            ("admin", "p71", "Select one event and request attendance PDF"),
            ("p71", "d2", ""),
            ("p71", "d4", ""),
            ("p71", "p72", ""),
            ("p72", "d4", ""),
            ...
            ("p72", "p73", ""),
            ("p73", "p74", ""),
            ("p74", "admin", "Private downloadable attendance PDF"),
            ("p74", "d6", ""),
            ("p74", "p75", ""),
            ("p75", "d7", ""),
        ],
