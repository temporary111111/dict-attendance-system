...
def main() -> None:
    ...
    write_drawio(
        ...
        [
            ...
            ("system", "program_admin", "Generated template-based attendance sheet, if allowed"),
            ("system", "super_admin", "Generated template-based attendance sheet"),
        ],
    )
    ...
    write_drawio(
        ...
        [
            ...
            ("program_admin", "p3", "Assigned event details/status changes"),
            ("p3", "d2", ""),
            ("p3", "d3", ""),
            ("p3", "d4", ""),
            ("super_admin", "p4", "QR/link request"),
            ("program_admin", "p4", "Assigned QR/link request"),
            ("p4", "d4", ""),
            ("p4", "super_admin", "Public attendance link and QR code"),
            ("p4", "program_admin", "Assigned public attendance link and QR code"),
            ...
            ("p7", "program_admin", "Assigned reports and sheets, if allowed"),
