...
def main() -> None:
    ...
    tables = [
        ...
        (
            ...
            ["field_key PK", "field_label", "default_is_required", "is_admin_configurable", "display_order UK"],
            645,
            650,
            285,
            165,
        ...
        (
            "event_field_settings",
            "event_attendance_field_settings",
            ["event_id PK, FK", "field_key PK, FK", "is_required", "created_at", "updated_at"],
            1345,
            735,
            300,
            165,
    ...
    edges = [
        ...
        ("events", "event_field_settings", "1:M"),
        ("form_fields", "event_field_settings", "1:M"),
